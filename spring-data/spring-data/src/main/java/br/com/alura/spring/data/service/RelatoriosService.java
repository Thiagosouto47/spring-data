...
public class RelatoriosService {
	...
	private void buscaFuncionarioNome(Scanner scanner) {
		...
		//http://localhost:8080/app/h2/login.do?jsessionid=0fc30efd39d2d85076454492a4f9dd78
	}
	...
	private void pesquisafuncionarioSalario() {
       ...
       list.forEach(f -> System.out.println("Funcionario: id: "+ f.getIdent() +
    		   " | nome: "+ f.getNome()+ "| salario: " + f.getSalar()));
